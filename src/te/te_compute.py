...
import src.te.helper as helper
import src.te.GPU_TE as gte
import src.te.CPU_TE as cte
...
def te_compute(X, Y, k=1, embedding=1, safetyCheck=False, GPU=False):
    ...
    # Make Spaces
    xkyPts, kyPts, xkPts, kPts, nPts = helper.make_spaces(X, Y, embedding=embedding)
